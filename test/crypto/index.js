...
describe("crypto.js", function () {
  ...
  describe("#getAddress", function () {
    ...
    it("should generate address by publicKey - second test", function () {
      ...
      (address).should.be.ok;
      (address).should.be.type("string");
      (address).should.be.equal("BD83X1LMN5w1pCN4z3ix7Uj6UayB21r1ah");
    });
...
describe("different networks", function () {
  ...
  it("validate address on tesnet should be ok", function () {
    bench.crypto.setNetworkVersion(0x52);
    bench.crypto.getNetworkVersion().should.equal(0x52);
    var validate = bench.crypto.validateAddress("a6fpb1BJZq4otWiVsBcuLG1ZGs5WsqqQtH");
    (validate).should.equal(true);
    bench.crypto.setNetworkVersion(0x17);
    bench.crypto.getNetworkVersion().should.equal(0x17);
  });
});

describe("delegate.js", function () {
  var delegate = bench.delegate;
  ...
  describe("#createDelegate", function () {
    ...
    describe("returned delegate", function () {
      var keys = bench.crypto.getKeys("secret");
      var secondKeys = bench.crypto.getKeys("secret 2");
      ...
      it("should be second signed correctly", function () {
        var result = bench.crypto.verifySecondSignature(trs, secondKeys.publicKey);
        (result).should.be.ok;
      });
