...
describe("transaction.js", function () {
  ...
  var transaction = bench.transaction;
  ...
  describe("#createTransaction", function () {
    ...
    describe("returned transaction", function () {
      ...
      it("should be signed correctly", function () {
        var result = bench.crypto.verify(trs);
        result.should.equal(true);
      });

      it("should be deserialised correctly", function () {
        var deserialisedTx = bench.crypto.fromBytes(bench.crypto.getBytes(trs).toString("hex"));
  ...
  describe("createTransaction and try to tamper signature", function(){
    ...
    it("should not validate overflown signatures", function(){
      ...
      var old_transaction = bench.transaction.createTransaction('AacRfTLtxAkR3Mind1XdPCddj1uDkHtwzD', 1, null, 'randomstring');
      ...
      */
      ...
      // console.log("TXID " + bench.crypto.getId(old_transaction));
      // console.log("VERIFY " + bench.crypto.verify(old_transaction));
      // console.log("SIG " + old_transaction.signature + "\n");

      bench.crypto.verify(old_transaction).should.equal(true);
      ...
      bench.crypto.verify(old_transaction).should.equal(false);
  ...
  describe("#createTransaction with second secret", function () {
    ...
    var keys = bench.crypto.getKeys(secondSecret);
    ...
    describe("returned transaction", function () {
      ...
      it("should be second signed correctly", function () {
        var result = bench.crypto.verifySecondSignature(trs, keys.publicKey);
        (result).should.equal(true);
      });
